...
from models.rl_model_convlstm import Model
import time
import wandb
...
def get_config():
    ...
    parser.add_argument("--energy", type=int, default=50)
...
def main():
    ...
    # Initialize wandb
    wandb.init(
        project="dynamic_resource_allocation1",
        name=f"TaxiBJ-CONVLSTM-energy={50}-num={10}-gpu={0}",
        group="OURS-RL",
