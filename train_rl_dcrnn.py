...
from models.rl_model_dcrnn import Model
import time
import wandb
...
def get_config():
    ...
    parser.add_argument("--energy", type=int, default=30, help="energy budget")
    parser.add_argument("--region_size", type=list, default=[2,2], help="region size")
