...
class Model(nn.Module):
    ...
    def get_energy_cost(self, agent_pos, candidate_pos):
        # Calculate energy cost based on Euclidean distance
        ...
        for t in range(T):
            ...
            for b in range(B):
                ...
                for i in range(self.agent_num):
                    ...
                    # Process demand and capacity constraints
